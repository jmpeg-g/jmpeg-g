...
public abstract class SAMRecord implements SequenceRecord {
    ...
    public void setHasMultipleSegments(boolean value) {
        setFlag(HAS_MULTIPLE_SEGMENTS, value);
    }

    public void setSegmentProperlyAligned(boolean value) {
        setFlag(SEGMENT_PROPERLY_ALIGNED, value);
    }

    public void setUnmappedSegment(boolean value) {
        setFlag(UNMAPPED_SEGMENT, value);
    }

    public void setNextSegmentUnmapped(boolean value) {
        setFlag(NEXT_SEGMENT_UNMAPPED, value);
    }

    public void setReverseComplemented(boolean value) {
        setFlag(REVERSE_COMPLEMENTED, value);
    }

    public void setNextSegmentReverseComplemented(boolean value) {
        setFlag(NEXT_SEGMENT_REVERSE_COMPLEMENTED, value);
    }

    public void setFirstSegment(boolean value) {
    ...
    public void setNotPassingQuality(boolean value) {
        setFlag(NOT_PASSING_QUALITY, value);
    }

    public void setOpticalDuplicate(boolean value) {
    ...
    public byte[] getOriginalQualityBytes() {
