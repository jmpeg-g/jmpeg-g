...
/**
 * Decoder for the 13.2.5.2.9.4	RLEQV transformation.
 * 
 * @author Dmitry Repchevsky &amp; Daniel Naro
 */

public class CABAC_RLEQVCodingDecoder extends RLECodingDecoder {

    public final SyntaxElementDecoder decoder;
    
    public CABAC_RLEQVCodingDecoder(
    ...
    @Override
    protected long decode() throws IOException {
