...
import es.gencom.mpegg.format.ref.DatasetReference;
...
public class FASTAToLocalMPEGGReference {
    public static Reference generate(
            ...
            byte datasetGroupId,
            byte datasetId) throws IOException {
        ...
        Reference reference = new DatasetReference(
